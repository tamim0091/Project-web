<?php
require_once '../controller/UserController.php'; // Include the UserController to fetch user data
require_once '../config.php'; // Include database configuration for connection
